...
def get_best_runs(data='mnist', batch_size=100, objective='PCC', mode='Train', momentum=0.9):
    ...
    best_df = summary_df.groupby(['model', 'lr', 'momentum'])[f'{mode} {objective}'].mean().reset_index()
    # summary_df = summary_df.loc[summary_df['momentum'] == momentum]
